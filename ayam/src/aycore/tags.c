 ...
 *  however, it must be guaranteed, that the tags
 *  are not modified during such a sequence;
 *  thus, the first call in a sequence should be
 *  ay_tags_append(o, NULL); to properly initialize
 *  the last pointer
 */
int
