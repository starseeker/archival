...
void
movedown (GRIDCELL * cube, world * w)
{
#define length w->edgelength
...
void
moveleft (GRIDCELL * cube, world * w)
{
#define length w->edgelength
...
void
moveright (GRIDCELL * cube, world * w)
{
#define length w->edgelength
...
void
movefront (GRIDCELL * cube, world * w)
{
#define length w->edgelength
...
void
moveback (GRIDCELL * cube, world * w)
{
#define length w->edgelength
